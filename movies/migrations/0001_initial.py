    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('world_premiere', models.DateField(auto_now_add=True, verbose_name='Премьера в мире')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='movies.Actor', verbose_name='режиссёры')),
